...
%
% Jasper Ridge -->  VNIR HSI captured by the NASA AVIRIS system
...
addpath('Data_base\Jasper_Ridge');
addpath('EBEAE');
addpath('NMF-QMV');
addpath('GraphL');
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('Jasper Ridge Hyperspecytal Dataset');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('GLNMF Analysis');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
...
mu=0.01; nu=1e-03; tau=1e-07;
sc=[mu,nu,tau, Nsamples,Nsamples];
paramvec=[3,rho,lambda,epsilon,maxiter,parallel,normalization,disp_iter];
