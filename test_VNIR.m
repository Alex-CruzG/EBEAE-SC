%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Synthetic Evaluation of EBEAE-TV with VNIR Hyperspectral Dataset
%
...
figure(1);
subplot(5,1,1);
plot(bands,Po,'LineWidth',2); grid on;
axis([450 950 0 max(max(Po))]);
...
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('Synthetic VNIR Hyperspecytal Dataset');
disp('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%');
disp('GLNMF Analysis');
...
figure(1);
subplot(5,1,2);
plot(bands,P1,'LineWidth',2); grid on;
axis([450 950 0 max(max(Po))]);
xlabel('Wavelength (nm)');
ylabel('Normalized Intensity');
...
figure(1);
subplot(5,1,3);
plot(bands,P3,'LineWidth',2); grid on;
axis([450 950 0 max(max(Po))]);
xlabel('Wavelength (nm)');
ylabel('Normalized Intensity');
...
figure(1);
subplot(5,1,4);
plot(bands,P4,'LineWidth',2); grid on;
axis([450 950 0 max(max(Po))]);
xlabel('Wavelength (nm)');
ylabel('Normalized Intensity');
...
figure(1);
subplot(5,1,5);
plot(bands,P5,'LineWidth',2); grid on;
axis([450 950 0 max(max(Po))]);
xlabel('Wavelength (nm)');
ylabel('Normalized Intensity');
...
disp(['EBEAE-TV Estimation Error in Measurements=' num2str(norm(Y-Yh6,'fro')/K)]);
disp('%%%%%%%%%%%%%%%%%%%');
